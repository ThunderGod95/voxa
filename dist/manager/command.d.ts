...
import type { CommandContext, CommandFeedbackRenderer, CommandLogger } from "../context";
/** @internal Empty schema used by commands that declare no arguments. */
export declare const EMPTY_ARGUMENTS: {};
/**
 ...
 */
export interface CommandDefinition<Schema extends ArgumentSchema = typeof EMPTY_ARGUMENTS> {
    /**
 ...
 */
export type Command<Schema extends ArgumentSchema = typeof EMPTY_ARGUMENTS> = CommandDefinition<Schema> & {
    name: string;
};
/**
 ...
 * ```
 */
export declare function defineCommand<const Schema extends ArgumentSchema = typeof EMPTY_ARGUMENTS>(command: Command<Schema>): Command<Schema>;
/**
 * Defines a directory-loaded command whose name may be derived from its
 * filename.
 */
export declare function defineCommand<const Schema extends ArgumentSchema = typeof EMPTY_ARGUMENTS>(command: CommandDefinition<Schema>): CommandDefinition<Schema>;
/**
 ...
 */
export declare function defineCommandGroup(group: CommandGroup): CommandGroup;
/**
