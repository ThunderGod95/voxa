...
export type SlashCommandTarget =
    | GlobalSlashCommandTarget
    | GuildSlashCommandTarget
    | GuildsSlashCommandTarget;
...
export type TokenSlashCommandRegistrarConfig =
    BaseSlashCommandRegistrarConfig & {
        token: string;
...
export type RestSlashCommandRegistrarConfig =
    BaseSlashCommandRegistrarConfig & {
        rest: REST;
        token?: never;
        authPrefix?: never;
...
export type CustomClientSlashCommandRegistrarConfig =
    BaseSlashCommandRegistrarConfig & {
...
export type SlashCommandRegistrarConfig =
    | TokenSlashCommandRegistrarConfig
    | RestSlashCommandRegistrarConfig
    | CustomClientSlashCommandRegistrarConfig;
...
export class SlashCommandRegistrationError extends Error {
    public readonly scope: "global" | "guild";
